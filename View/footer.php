        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-xs-6 col-sm-6">
                    ...
                    <div class="footer_widget_title"><h2>Haqqimizda</h2></div>
                ...
                <div class="col-md-6">
                    <div class="footer_widget f_right">
                        <div class="footer_widget_title"><h2>Menu</h2></div>
                        <div class="footer_menu_item ">
                        <div class="row">
                            <div class="col-sm-6"> 
                                <ul>
                                    <li><a href="home">Ana seyfe</a></li>
                                    <li><a href="olke">Olke</a></li>
                                    <li><a href="siyaset">Siyaset</a></li>
                                    <li><a href="sou_biznes">Soubiznes</a></li>
                             ...
                             <div class="col-sm-6"> 
                                <ul>
                                    ...
                                    <li><a href="idman">Idman</a></li>
                                    <li><a href="maraqli">Maraqli</a></li>
                                </ul>
                            </div><!--col-sm-6-->
